...
CREATE TRIGGER update_mesas_updated_at BEFORE UPDATE ON mesas_clientes FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_productos_updated_at BEFORE UPDATE ON productos FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

-- DATOS INICIALES - 12 MESAS
...
INSERT INTO productos (nombre, categoria, precio, stock, stock_minimo, unidad, precio_compra, proveedor) VALUES
  ...
  ('Tacos al Pastor', 'Comida', 12.00, 40, 20, 'porciones', 6.00, 'Carnicería'),
  ('Alitas Picantes', 'Comida', 12.00, 35, 15, 'porciones', 6.00, 'Pollería'),
  ('Ensalada César', 'Comida', 10.00, 25, 10, 'porciones', 5.00, 'Verduras'),
